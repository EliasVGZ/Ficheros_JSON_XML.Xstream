...
public class ObjetoAFichero {
    public static void main (String args []) throws IOException{
        ...
        try (FileWriter writer = new FileWriter("src/ficheros/datos_personaConAsig.json")) {
    ...
    public static void GuardarJSON(String json){
        try (
            BufferedWriter bw = new BufferedWriter(new FileWriter("src/ficheros/datos_personaConAsig.json"))) {
            bw.write(json);
